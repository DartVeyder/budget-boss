<div class="row">
    ...
    <div class="col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm p-4 h-100 border-top border-3 border-danger">
            <h5 class="text-muted mb-4 fw-bold text-uppercase" style="letter-spacing: 0.5px;">{{ __('По рахунках (Витрати)') }}</h5>
            <div class="d-flex flex-column gap-3">
                @php
                    $billItems = $charts['expenses']['bill'][0]['items'] ?? [];
                @endphp
    ...
    <div class="col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm p-4 h-100 border-top border-3 border-danger">
            <h5 class="text-muted mb-4 fw-bold text-uppercase" style="letter-spacing: 0.5px;">{{ __('По джерелах (Витрати)') }}</h5>
            <div class="d-flex flex-column gap-3">
                @php
                    $sourceItems = $charts['expenses']['source'][0]['items'] ?? [];
                @endphp
